...
- Define and document a `Props` interface in every reusable component's frontmatter. Describe each prop's purpose, defaults, and constraints where applicable.
...
- Comments should explain intent, decisions, or constraints rather than restating markup or expressions. Keep component API documentation current.
